...
void main() {
  ...
  test('can get the largest product of a big number', () {
    final result = lsp.largestProduct(
  ...
  test('rejects span longer than string length', () {
    expect(
        ...
        throwsA(isA<ArgumentError>().having((e) => e.message, 'message',
            contains('span must be smaller than string length'))));
  }, skip: false);
  ...
  test('rejects invalid character in digits', () {
    expect(
        ...
        throwsA(isA<ArgumentError>().having((e) => e.message, 'message',
            contains('digits input must only contain digits'))));
  }, skip: false);
  ...
  test('rejects negative span', () {
    expect(
        ...
        throwsA(isA<ArgumentError>().having((e) => e.message, 'message',
            contains('span must not be negative'))));
  }, skip: false);
}
